...
namespace BitmapBufferEx
{
    ...
    public static partial class BitmapBufferExtensions
    {
        ...
        public static unsafe void CopyBlit(this BitmapBuffer bmp, int dstX, int dstY, BitmapBuffer source)
        {
            //just copy blit
            //no scaling,
            //blendMode=NONE
            ...
            using (BitmapContext destContext = bmp.GetBitmapContext())
            {
                ...
                int* sourcePixels = srcContext.Pixels._inf32Buffer;
        ...
        /// <param name="blendMode">The blending mode <see cref="BlendMode"/>.</param>
        internal static unsafe void Blit(this BitmapBuffer bmp,
            RectD destRect,
            BitmapBuffer source,
            RectD sourceRect,
            ColorInt color,
            ...
            GeneralTransform transform = null)
        {
            ...
            using (BitmapContext destContext = bmp.GetBitmapContext())
            {
                ...
                {
                    int* sourcePixels = sourceContext.Pixels._inf32Buffer;
