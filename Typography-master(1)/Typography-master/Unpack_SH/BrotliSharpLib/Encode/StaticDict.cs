...
namespace BrotliSharpLib
{
    public static partial class Brotli
    {
        ...
        private static unsafe size_t DictMatchLength(
            byte* data,
            size_t id,
            size_t len,
            size_t maxlen)
        ...
        private static unsafe bool IsMatch(
            DictWord w, byte* data, size_t max_length)
        {
            if (w.len > max_length)
            {
                return false;
        ...
        private static unsafe bool BrotliFindAllStaticDictionaryMatches(
            byte* data, size_t min_length,
            size_t max_length, uint* matches)
        {
            bool has_found_match = false;
            {
                ...
                while (!end)
                {
                    ...
                    {
                        size_t matchlen =
                            DictMatchLength(data, id, l, max_length);
                        byte* s;
                        size_t minlen;
                        size_t maxlen;
                        size_t len;
