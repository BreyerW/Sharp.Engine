...
namespace Sharp.Editor.Views
{
	public class SceneView : View
	{
		...
		private void PickTestForObject()
		{
			...
			foreach (var ent in entities.root)
			{
	...
	public class Root
	{
		...
		internal Dictionary<Guid, IEngineObject> allEngineObjects = new Dictionary<Guid, IEngineObject>();
