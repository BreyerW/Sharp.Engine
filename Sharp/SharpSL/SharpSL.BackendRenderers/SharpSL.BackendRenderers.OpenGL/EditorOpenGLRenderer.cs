...
namespace SharpSL.BackendRenderers.OpenGL
{
    public class EditorOpenGLRenderer : IEditorBackendRenderer
    {
        ...
        void bvh_to_vertices(Bone joint, ref List<Vector4> vertices,
        ...
        void DisplayOcta(Bone bone)
        {
            ...
            var tail = bone.Children.Count > 0 ? bone.Children[0].Offset.Inverted().Column3.Xyz : Vector3.Transform(Vector3.Zero, mat); //or borrow last length
    ...
    new []{ 0.0f, 1.0f,  0.0f}
        ...
        static int[] bone_octahedral_wire_sides = new int[] { 0, 1, 5, 3, 0, 4, 5, 2 };
        static int[] bone_octahedral_wire_square = new int[] { 1, 2, 3, 4, 1 };
