...
namespace Squid
{
    ...
    public partial class Control
    {
        ...
        public event VoidEvent VisibilityChanged;
    ...
    public partial class Control
    {
        ...
        [DefaultValue(true)]
        [Category("Base")]
        public bool IsVisible { get { return _visible; } set { _visible = value; if (VisibilityChanged != null) VisibilityChanged(this); } }
        ...
        internal void PerformUpdate()
        {
            ...
            if (FadeSpeed > 0 || UI.GlobalFadeSpeed > 0)
            {
                ...
                float delta = (float)(UI.TimeElapsed / speed);
        ...
        protected virtual void DrawText(Style style, float opacity, int charsToDraw = -1) { }
        ...
        internal void DoKeyEvents()//TODO: bugs with onKeyUp and Down
        {
            if (NoEvents) return;
