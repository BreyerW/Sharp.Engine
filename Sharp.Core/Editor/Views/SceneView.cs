...
namespace Sharp.Editor.Views
{
	public class SceneView : View
	{
		...
		private static void LoadScene()
		{
			...
			ref var sh = ref ShaderPipeline.Import(Application.projectPath + @"\Content\WireframeShader.shader");
			...
			ref var cubeTexture = ref TexturePipeline.Import(Application.projectPath + @"\Content\viewcube_textured.png");
			ref var mask = ref TexturePipeline.Import(Application.projectPath + @"\Content\viewcube_mask.png");
			...
			ref var selectionTexture = ref TexturePipeline.GetAsset("highlightScene");
			highlight.BindProperty("MyTexture", selectionTexture);
			ref var selectionDepthTexture = ref TexturePipeline.GetAsset("highlightDepth");
