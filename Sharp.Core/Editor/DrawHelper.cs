...
namespace Sharp.Editor
{
	public static class DrawHelper
	{
		...
		static DrawHelper()
		{
			shader = ShaderPipeline.Import(Application.projectPath + @"\Content\GizmoShader.shader");

			ref var circleMesh = ref MeshPipeline.GetAsset("gizmo");
			...
			ref var screenCircleMesh = ref MeshPipeline.GetAsset("screen_circle");
