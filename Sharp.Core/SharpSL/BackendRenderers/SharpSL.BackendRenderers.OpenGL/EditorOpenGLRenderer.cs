...
namespace SharpSL.BackendRenderers.OpenGL
{
	public class EditorOpenGLRenderer : IEditorBackendRenderer
	{
		...
		public void DrawRotateGizmo(float thickness, float scale, ref float xColor, ref float yColor, ref float zColor)
		{
			//this.SetupGraphic();
		...
		public void DrawTranslateGizmo(float thickness, float scale, ref float xColor, ref float yColor, ref float zColor)
		{
		...
		public void DrawScaleGizmo(float thickness, float scale, ref float xColor, ref float yColor, ref float zColor, System.Numerics.Vector3 offset)
		{
		...
		public void DrawDiamond(Vector2 pos, Vector2 dir, ref float color)
		{
			GL.Color4(ref color);
		...
		public void DrawCircle(float size, float lineWidth, ref float unColor, Plane plane, float angle = 360, bool filled = false)
		{
			GL.Enable(EnableCap.Blend);
			GL.BlendFunc(BlendingFactorSrc.SrcAlpha, BlendingFactorDest.OneMinusSrcAlpha);
			GL.Color4(ref unColor);
		...
		public void DrawSphere(float radius, int lats, int longs, ref float unColor)
		{
			GL.Color4(ref unColor);
			int num10;
		...
		public void DrawCube(float size, float posX, float posY, float posZ, ref float unColor)
		{
			float[] vertices =
			{
				 0.0f, 0.0f, 0.0f,
		...
		public void DrawPlaneXZ(float size, float sizeOffset, ref float unColor)
		{
			size += sizeOffset;
			GL.Color4(ref unColor);
			GL.Begin(PrimitiveType.Quads);
		...
		public void DrawPlaneZY(float size, float sizeOffset, ref float unColor)
		{
			size += sizeOffset;
			GL.Color4(ref unColor);
			GL.Begin(PrimitiveType.Quads);
		...
		public void DrawPlaneYX(float size, float sizeOffset, ref float unColor)
		{
			size += sizeOffset;
			GL.Color4(ref unColor);
			GL.Begin(PrimitiveType.Quads);
