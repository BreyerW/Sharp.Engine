...
namespace Sharp
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        {
            return new Color((byte)(val1.R + (val2.R - val1.R) * time), (byte)(val1.G + (val2.G - val1.G) * time), (byte)(val1.B + (val2.B - val1.B) * time), (byte)(val1.A + (val2.A - val1.A) * time));
        }
        ...
        public static Color operator *(Color value, Color scale)
        {
            var scalar = scale.ToVector4();
            return new Color((byte)(value.R * scalar.X), (byte)(value.G * scalar.Y), (byte)(value.B * scalar.Z), (byte)(value.A * scalar.W));
        }
