...
namespace UniversalSerializerLib3
{
    ...
    /// </summary>
    internal struct JSONElementName
    {
    ...
    /// </summary>
    internal struct JSONAttributeName
    {
    ...
    internal sealed class JSONSerializationFormatter : SerializationFormatter
    {
        ...
        internal static readonly string[] JSONElementNames = new string[]
        {
			...
			JSONElementName.PrimitiveValue , // "e",
        ...
        private void WriteStringToAssembledOrMultiplexStream(string s)
        {
...
, out bool TheElementHaveAttributes
        ...
        private static bool _enterElementAttribute(StringBuilder s, AttributeTypes AttributeType, object value, bool firstAttributeOrSubBranch)
        {
            if (value == null)
                return false;
        ...
        private static bool _enterElementAttribute(StringBuilder s, string AttributeName, string value, bool firstAttributeOrSubBranch)
        {
            if (value == null)
                return false;
...
, null
        ...
        private bool WeAlreadyObtainedJSONPart = false;
