...
namespace UniversalSerializerLib3
{
    ...
    internal class CLRTypeContainer : ITypeContainer
    {
        ...
        private bool _IsValidType(System.Type type)
        {
        ...
        private static Dictionary<Type, bool> IsValidTypeCache = new Dictionary<Type, bool>();
        private static Type tType = typeof(Type);
        ...
        private static ITypeContainer CreateATypeContainerGeneric(
        ...
        private static Type GenericType = typeof(CLRTypeContainerGeneric<>);

        private static Dictionary<Type, Type> GenericContainersTypeCache
